...
#
# This is the "default" variant: coroutines run on Kotlin's own scheduler,
# Dispatchers.Default. The scheduler choice lives entirely in benchutil.kt; the
# benchmark sources are shared verbatim with kotlin/fjp.
#
