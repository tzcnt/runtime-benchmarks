...
// Also inserts values at for each different type of core without SMT, and the
// max with SMT e.g. on a 13600k inserts: 6 (number of P-cores) 14 (number of P
// + E-cores) 20 (6*2 for P-cores SMT + 8 for E-cores without)

int main(int argc, char* argv[]) {
  // Get the breakpoints (number of physical cores of different kinds, and max
  // with SMT)
  ...
  std::set_union(
    doubling.begin(), doubling.end(), breakpoints.begin(), breakpoints.end(),
